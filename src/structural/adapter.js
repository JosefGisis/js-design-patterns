 ...
 * 
 * In this example we won't use subclassing to adapt an interface, but rather we will use object composition and prototypical
 * inheritance to adapt the interface of an object.
 *
